      ...
      <div className="flex items-center  md:px-20 md:py-6 p-10 justify-between">
        ...
        <div className="flex items-center gap-3 w-1/2">
          <div className="w-full">
            <input
              class="shadow appearance-none border rounded w-4/5 border-[#505352] p-3 bg-transparent leading-tight focus:outline-none focus:shadow-outline text-white"
              id="referAddress"
              value={referAddress}
              onChange={refer}
              type="text"
          ...
          <div
            className="connect-wallet cursor-pointer p-2 flex gap-4 w-2/5 items-center justify-center rounded-lg text-center text-white"
            onClick={referAddressButton}
          >
            <p> Refer Address</p>
          </div>
        </div>
